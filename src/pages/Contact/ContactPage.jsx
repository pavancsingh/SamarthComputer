        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
          ...
          <div className="lg:col-span-5 flex flex-col gap-gutter">
            ...
            <div className="bg-white rounded-xl border border-slate-200/50 p-lg shadow-stitch-md hover:shadow-stitch-lg transition-all duration-300">
              ...
              <div className="mt-lg pt-lg border-t border-slate-100 space-y-3">
                <a
                ...
                <div className="grid grid-cols-3 gap-2 pt-1">
                  {settings.socialFacebook && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-1.5 bg-blue-50 text-blue-700 hover:bg-blue-100 py-2 px-2 rounded-lg text-xs font-bold transition-colors"
                    >
                  ...
                  {settings.socialInstagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-1.5 bg-pink-50 text-pink-700 hover:bg-pink-100 py-2 px-2 rounded-lg text-xs font-bold transition-colors"
                    >
                  ...
                  {settings.socialYoutube && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-1.5 bg-red-50 text-red-700 hover:bg-red-100 py-2 px-2 rounded-lg text-xs font-bold transition-colors"
                    >
